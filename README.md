...
Project Overview:
A PostgreSQL-backed analytics system for tracking player performance in a simulated esports league (ESMO).
The system automates match data ingestion and computes advanced performance metrics including KDA averages, objective control rates, and MVP rankings.

Key Features:
- Automated 10-player match ingestion
- Season-based filtering
- Objective tracking for junglers
- Aggregate statistics (KDA, win rate, champion usage)
- Custom MVP scoring logic
- Data normalization across multiple seasons




Attributions and Background Info:
